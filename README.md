...
> **Current Version**：`3.3.x.20241020-SNAPSHOT`<br>
> **JDK Baseline**：`17`<br>
...
**pac4j-spring-boot-starter** is a Spring Boot starter that integrates **pac4j** for applications using pac4j. It provides auto-configuration, property binding, and ready-to-use beans so that applications can consume pac4j capabilities with minimal setup.

| Dimension | Description |
|---|---|
| Type | Spring Boot Starter |
| Consumers | Spring Boot applications using pac4j |
| Core Capabilities | auto-configuration, property binding, ready-to-use beans for pac4j |
| JDK | `17` |
| Coordinates | `io.github.easy4j:pac4j-spring-boot-starter:3.3.x.20241020-SNAPSHOT` |
| Config Prefix | `pac4j` |
...
|---|:---:|---|
| Auto-configuration | ✅ Stable | Registers pac4j beans automatically |
